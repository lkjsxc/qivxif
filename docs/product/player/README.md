...
Use this subtree for player controls, identity, progression, and lifecycle.
...
- Player documents describe player-visible behavior.
- Architecture documents own transport and replication mechanics.
- Gameplay documents own combat, crafting, bases, events, and economy.
