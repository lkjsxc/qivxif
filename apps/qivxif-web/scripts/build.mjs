...
await copyModule(join(app, "src", "actors", "publish-actions.ts"));
await copyModule(join(app, "src", "actors", "social-actions.ts"));
...
await copyModule(join(app, "src", "ui", "publish.ts"));
await copyModule(join(app, "src", "ui", "social.ts"));
